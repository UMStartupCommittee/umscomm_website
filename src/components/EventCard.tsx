...
const EventCard: React.FC<EventCardProps> = ({ title, description, date, onViewEvent, href }) => {
  return (
    <div className="bg-background rounded-lg pr-6 shadow-1 grid grid-cols-6">
      ...
      <div className='col-span-5'>
        ...
        <p className="text-base lg:text-lg text-foreground/80 mb-4 text-gray-400">{description}</p>
      </div>
